...
public class EducationManagementActorTest {
  ...
  public void testInsertUserEducationWithAddressSuccess() {
    ...
    boolean result =
        testScenario(getInsertEducationRequestWithAddress("insertUserEducation"), null);
    assertTrue(result);
  }
  ...
  public void testInsertUserEducationWithOutAddressSuccess() {
    ...
    when(addressDao.upsertAddress(Mockito.anyMap())).thenReturn(response);
    boolean result =
        testScenario(getInsertEducationRequestWithOutAddress("insertUserEducation"), null);
    assertTrue(result);
  }
  ...
  public void testInsertUserEducationWithAddressIdSuccess() {
    ...
    when(addressDao.upsertAddress(Mockito.anyMap())).thenReturn(response);
    boolean result =
        testScenario(getInsertEducationRequestWithAddressId("insertUserEducation"), null);
    assertTrue(result);
  }
  ...
  public void testInsertUserEducationWithOutAddressFailure() {
    ...
    Assert.assertEquals(
        "Error occurred while inserting education details.",
        ((List) result.get(JsonKey.ERROR_MSG)).get(0));
  }
  ...
  public void testUpdateUserEducationWithAddressIdSuccess() {
    ...
    when(addressDao.upsertAddress(Mockito.anyMap())).thenReturn(response);
    boolean result =
        testScenario(getInsertEducationRequestWithAddressId("updateUserEducation"), null);
    assertTrue(result);
  }
  ...
  public void testUpdateUserEducationWithAddressSuccess() {
    ...
    when(addressDao.upsertAddress(Mockito.anyMap())).thenReturn(response);
    boolean result =
        testScenario(getUpdateEducationRequestWithAddress("updateUserEducation"), null);
    assertTrue(result);
  }
  ...
  public void testUpdateUserEducationWithOutAddressSuccess() {
    ...
    when(educationDao.getPropertiesValueById(Mockito.anyString(), Mockito.anyString()))
        .thenReturn(getAddressIdInResponse());
    boolean result =
        testScenario(getInsertEducationRequestWithOutAddress("updateUserEducation"), null);
    assertTrue(result);
  }
