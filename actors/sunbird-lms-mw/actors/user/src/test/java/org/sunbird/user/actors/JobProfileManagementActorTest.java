...
public class JobProfileManagementActorTest {
  ...
  public void testUpdateUserJobProfileWithAddressSuccess() {
    ...
    when(addressDao.upsertAddress(Mockito.anyMap())).thenReturn(response);
    boolean result =
        testScenario(getJobProfileRequestWithAddressAndId("updateUserJobProfile"), null);
    assertTrue(result);
  }
  ...
  public void testInsertUserJobProfileWithAddressFailure() {
    ...
    Assert.assertEquals(
        "Error occurred while inserting job profile details.",
  ...
  public void testUpdateUserJobProfileWithAddressFailure() {
    ...
    Assert.assertEquals(
        "Error occurred while updating job profile details.",
        ((List) result.get(JsonKey.ERROR_MSG)).get(0));
  }
  ...
  public void testInsertUserJobProfileWithInvalidOperation() {
    ...
    boolean result =
        testScenario(
            getJobProfileRequestWithAddress("invalidOperation"), ResponseCode.invalidRequestData);
