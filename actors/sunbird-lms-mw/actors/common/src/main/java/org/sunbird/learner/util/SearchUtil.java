...
public class SearchUtil {
    private static final String BASE_URL = ProjectUtil.getConfigValue(JsonKey.SEARCH_SERVICE_API_BASE_URL);
    ...
    public static List<Map<String, Object>> search(String payload) throws UnirestException, IOException {
        if(StringUtils.isNotBlank(payload)){
            ...
            if(httpResponse.getStatus() == 200){
                ...
                throw new ProjectCommonException(ResponseCode.SERVER_ERROR.name(), httpResponse.getBody(), ResponseCode.SERVER_ERROR.getResponseCode());
            }
        }
        return null;
    }
