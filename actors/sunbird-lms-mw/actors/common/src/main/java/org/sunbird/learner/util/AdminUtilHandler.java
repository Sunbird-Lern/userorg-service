...
public class AdminUtilHandler {
  ...
  public static Map<String, Object> fetchEncryptedToken(AdminUtilRequestPayload reqObject) {
    ...
    try {
      ...
      ProjectLogger.log(
          "AdminUtilHandler :: fetchEncryptedToken: request payload" + body, LoggerEnum.DEBUG);
      ...
      String response =
          HttpClientUtil.post(
              ...
              headers);
      ProjectLogger.log(
          "AdminUtilHandler :: fetchEncryptedToken: response payload" + response, LoggerEnum.DEBUG);
