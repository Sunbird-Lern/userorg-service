...
public class UserControllerTest3 extends BaseApplicationTest {
  ...
  public Result performTest(String url, String method, Map map) {
    ...
    if (StringUtils.isNotBlank(data)) {
      ...
      req = new RequestBuilder().bodyJson(json).uri(url).method(method);
    } else {
      req = new RequestBuilder().uri(url).method(method);
    }
