...
import controllers.skills.util.TestUtil;
...
public class UserSkillControllerTest {
  private static String RESOURCE_PATH = "userSkillTest/";
  ...
  public void testAddSkill() {
    setup();
    Map<String, Object> requestMap = getJSONFileAsMap("create-user-skill-success.json");
  ...
  public void testdeleteSkill() {
    setup();
    Map<String, Object> requestMap = getJSONFileAsMap("delete-user-skill-success.json");
    String data = mapToJson(requestMap);
  ...
  public void testUpdateSkill() {
    setup();
    Map<String, Object> requestMap = getJSONFileAsMap("update-user-skill-success.json");
    String data = mapToJson(requestMap);
