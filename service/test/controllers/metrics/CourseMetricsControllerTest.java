...
public class CourseMetricsControllerTest {
  ...
  public void testcourseProgress() {
    ...
    RequestBuilder req =
        new RequestBuilder().uri("/v1/dashboard/progress/course/batchId?period=7d").method("GET");
  ...
  public void testcourseCreation() {
    ...
    RequestBuilder req =
        new RequestBuilder()
            .uri("/v1/dashboard/consumption/course/courseId?period=7d")
            .method("GET");
    req.headers(headerMap);
    Result result = route(req);
    assertEquals(200, result.status());
  ...
  public void testcourseProgressReport() {
    ...
    RequestBuilder req =
        new RequestBuilder()
            .uri("/v1/dashboard/progress/course/courseId/export?period=7d&format=excel")
            .method("GET");
    req.headers(headerMap);
    Result result = route(req);
    assertEquals(200, result.status());
