...
public class UserControllerTest extends BaseControllerTest {
  ...
  public void testSearchUserFailureWithoutFilters() {
    ...
    Result result =
        performTest(
            "/v1/user/search", "POST", (Map) getRequestedDataByRequiredParams(null, null, false));
    assertEquals(getResponseCode(result), ResponseCode.mandatoryParamsMissing.getErrorCode());
    assertTrue(getResponseStatus(result) == 400);
  }

  private Object getRequestedDataByRequiredParams(String userId, String loginId, boolean isFilter) {
