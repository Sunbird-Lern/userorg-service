...
public class IdentifierFreeUpControllerTest extends BaseApplicationTest {
    ...
    public void tesIdentifierFreeUpUserSuccess() {
        Result result = TestUtil.performTest("/private/user/v1/identifier/freeup", "POST", getRequest(),application);
    ...
    public void tesIdentifierFreeUpUserFailure() {
        Result result = TestUtil.performTest("/private/user/v1/identifier/freeup", "POST", getFailureReq(),application);
