  ...
  public void validateDataSecurityPolicySuccess() {
    ...
    String inputDataStr =
        "{\n"
            ...
            + "                    },\n"
            + "                    \"userinfo-exhaust\": {\n"
            + "                        \"level\": \"KEY_PROTECTED_ENCRYPTED_DATASET\",\n"
            + "                        \"dataEncrypted\": \"Yes\",\n"
            ...
            + "                \"PASSWORD_PROTECTED_ENCRYPTED_DATASET\": \"Data encrypted with a user provided encryption key. Generally applicable to non PII data but can contain sensitive information which may not be considered open.\",\n"
            + "                \"KEY_PROTECTED_ENCRYPTED_DATASET\": \"Data encrypted via an org provided public/private key. Generally applicable to all PII data exhaust.\"\n"
            + "            }\n"
            + "        }";
  ...
  public void validateDataSecurityPolicyPEException() {
    ...
    String inputDataStr =
        "{\n"
            ...
            + "                    },\n"
            + "                    \"userinfo-exhaust\": {\n"
            + "                        \"level\": \"PASSWORD_PROTECTED_ENCRYPTED_DATASET\",\n"
            + "                        \"dataEncrypted\": \"Yes\",\n"
            + "                        \"comments\": \"Decryption tool link need to be downloaded to decrypt the encrypted file.\"\n"
            + "                    }\n"
            + "                },\n"
