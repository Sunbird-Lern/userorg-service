...
/**
 * 
 * This class will handle all the method related to authentication.
 * example verifying user access token , creating access token after success login.
 * @author Manzarul
 *
 */
public class AuthenticationHelper {
	...
	/**
	 * This method will verify the incoming user access token against store 
	 * data base /cache . if token is valid then it would be associated with
	 * some user id. in case of token matched it will provide user id. else will 
