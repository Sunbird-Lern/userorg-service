...
public interface ResponseMessage {
  ...
  interface Message {
    ...
    String DB_INSERTION_FAIL = "DB Insertion Failed.";
    String DB_UPDATE_FAIL = "DB Update Failed.";
  ...
  interface Key {
    ...
    String INTERNAL_ERROR = "0015";
    String DB_INSERTION_FAIL = "0016";
    String DB_UPDATE_FAIL = "0017";

    String INVALID_PARAMETER_VALUE = "0018";
    String INVALID_VALUE = "0019";
    String INVALID_PARAMETER = "0020";
    String INVALID_COLUMNS = "0021";
    String INVALID_REQUEST_PARAMETER = "0022";
    String INVALID_REQUEST_TIMEOUT = "0023";
    String VALID_IDENTIFIER_ABSENSE = "0024";
    String INVALID_PASSWORD = "0025";
    String INVALID_CAPTCHA = "0026";
    String INVALID_CONSENT_STATUS = "0027";
    String INVALID_OPERATION_NAME = "0028";
    String INVALID_REQUESTED_DATA = "0029";
    String INVALID_LOCATION_DELETE_REQUEST = "0030";
    String MANDATORY_PARAMETER_MISSING = "0031";
