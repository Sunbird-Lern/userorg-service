...
/**
 * Handles Sendgrid email connection establishment and management.
 */
public class SendgridConnection {
  ...
  /**
   * Creates and establishes an SMTP connection.
   *
   ...
   *
   * @param session The mail session to set.
   */
  ...
  /**
   * Initializes email properties from the configuration cache.
   */
