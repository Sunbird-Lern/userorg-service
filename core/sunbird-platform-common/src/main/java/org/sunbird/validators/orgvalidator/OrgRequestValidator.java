...
/**
 * Validates requests related to Organization operations such as creation, update, and status change.
 */
public class OrgRequestValidator extends BaseOrgRequestValidator {
  ...
  /**
   * Validates the request for creating a new organization.
   *
   * @param orgRequest The request object containing organization details.
   */
  ...
  /**
   * Validates the license parameter if the organization is a tenant.
   *
   * @param orgRequest The request object.
   */
  ...
  /**
   * Validates the request for updating an existing organization.
   *
   * @param request The request object containing update details.
   */
  ...
  /**
   * Validates the request for updating the organization status.
   *
   * @param request The request object containing status update details.
   */
  ...
  /**
   * Validates that only one of Location ID or Location Code exists in the request to avoid conflicts.
   *
   * @param orgRequest The request object.
   */
  ...
  /**
   * Validates the encryption key request, ensuring the file and public key are valid.
   *
   * @param reqObj The request object.
   * @param body   The multipart form data containing the file.
   */
  ...
  /**
   * Validates the RSA public key format.
   *
  ...
  /**
   * Validates the file extension to ensure it is ".pem".
   *
