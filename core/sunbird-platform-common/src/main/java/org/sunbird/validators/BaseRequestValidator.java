 ...
 * Provides utility methods for validating request parameters, headers, and data types.
 *
...
public class BaseRequestValidator {
  ...
  /**
   * This method will create the ProjectCommonException by reading ResponseCode and errorCode. Use
   * case: If ResponseCode is null then it will throw invalidData error.
   *
  ...
  /**
   * Method to check whether given mandatory fields is in given map or not. Also checks the instance
   * of request attributes.
   *
   * @param data Map contains the key value.
   * @param mandatoryParamsList List of strings representing the mandatory fields.
   */
  ...
  /**
   * Method to check whether given fields are present in given map. If present, throws exception.
   * Used for update requests where certain properties cannot be updated.
   *
   * @param data Map contains the key value
   * @param keys List of string represents the fields that must NOT be present.
   */
  ...
  /**
   * Validates a search request ensuring filters are present and correctly typed.
   *
  ...
  /**
   * Validates if the requestedBy user is authorized.
   *
   * @param requestedBy The user ID making the request.
   */
