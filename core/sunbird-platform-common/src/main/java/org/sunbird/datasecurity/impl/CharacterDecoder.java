...
public abstract class CharacterDecoder {
   ...
   * @param bStream The output stream.
   ...
   * @param aStream The input stream.
   * @param bStream The output stream.
   * @param l The number of bytes to decode.
   * @throws IOException If an I/O error occurs.
   */
   ...
   * @param aStream The input stream.
   * @param bStream The output stream.
   * @throws IOException An error has occurred while decoding
   * @throws IOException The input stream is unexpectedly out of data
   */
   ...
   *
   * @param inputString The string to decode.
   * @return The decoded data as a ByteBuffer.
   * @throws IOException If an I/O error occurs.
   */
