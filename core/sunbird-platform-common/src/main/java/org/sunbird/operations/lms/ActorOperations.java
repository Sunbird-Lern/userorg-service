...
/**
 * Enum containing various operations performed by actors in the LMS system.
 * These operations cover courses, users, organisations, pages, and system settings.
 */
public enum ActorOperations {
  ...
  /**
   * Constructor for ActorOperations.
   *
