...
2. Run "mvn clean install -DCLOUD_STORAGE_GROUP_ID=org.sunbird -DCLOUD_STORAGE_ARTIFACT_ID=cloud-store-sdk -DCLOUD_STORAGE_VERSION=1.4.6" to build the services.
