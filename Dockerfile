...
CMD java -XX:+PrintFlagsFinal $JAVA_OPTIONS -Dplay.server.http.idleTimeout=180s -cp '/home/sunbird/learner/learning-service-1.0-SNAPSHOT/lib/*' -Dlogger.file=/home/sunbird/learner/learning-service-1.0-SNAPSHOT/config/logback.xml play.core.server.ProdServerStart  /home/sunbird/learner/learning-service-1.0-SNAPSHOT
