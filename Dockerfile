...
CMD java -XX:+PrintFlagsFinal $JAVA_OPTIONS -cp '/home/sunbird/learner/learning-service-1.0-SNAPSHOT/lib/*' play.core.server.ProdServerStart --Dplay.server.http.idleTimeout=180s  /home/sunbird/learner/learning-service-1.0-SNAPSHOT
